...
class LessonsController extends Controller {
    public function index($training_id) {
        ...
        return view('trainer.Lessons.lessons', ['lessons' => $lessons, 'training' => $training]);
    }

    public function create($training_id) {
        $training = Training::find($training_id);

        return view('trainer.Lessons.add_lesson', compact('training'));
    }
    ...
    public function store(Request $request, $training_id) {
        ...
        return redirect()->route('trainers.lessons', ['training_id' => $training_id])->with(['status' => 'success', 'message' => 'Lesson Added Successfully']);
    }
    ...
    public function edit($training_id, $id){
        ...
        return view('trainer.Lessons.edit_lesson', compact('lesson', 'training'));
    }
    ...
    public function update(Request $request, $training_id, $id) {
        ...
        return redirect()->route('trainers.lessons')->with(['status' => 'success', 'message' => 'Lesson Edited Successfully']);
    }
    ...
    public function destroy($training_id, $id) {
        ...
        return redirect()->route('trainers.lessons')->with(['status' => 'success', 'message' => 'Lesson Deleted Successfully']);
    }
