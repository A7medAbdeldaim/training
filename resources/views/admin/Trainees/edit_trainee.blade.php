                    ...
                    <div class="col-12">
                        <div class="card card-success">
                            <div class="card-header">
                                <h3 class="card-title">Edit a New Trainee</h3>
                            </div>
                            @include('templates.errors')
                            <form role="form" action="{{ route('admin.trainees.update', $trainee->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                {{ method_field('PATCH') }}
                                <div class="card-body col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" class="form-control"
                                               ...
                                               value="{{$trainee->name}}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Email</label>
                                        <input type="email" id="email" class="form-control"
                                               placeholder="Enter Trainee Email" name="email"
                                               value="{{$trainee->email}}" required>
                                    </div>
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-success btn-block">Edit Trainee</button>
                                </div>
                            </form>
                        </div>
                    </div>
